...
values
  ...
  ('10000000-0000-0000-0000-000000000024', 'ploy', (select id from public.users where lower(email) = lower('fco.thanyaporn@garena.com')), 'Ploy', 'PL', '#BF6B00', 'GD/VE', 'GD/VE', array['static-graphic']::public.asset_type[], '{}'::public.asset_type[], 8, null, 3, 'available', true),
