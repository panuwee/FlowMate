...
describe("Marketing Plan product split shell", () => {
  ...
  it("implements Campaign Timeline from Marketing Plan placement dates only", () => {
    ...
    expect(timelineSource).not.toContain("Manage Campaign");
    const plannerSource = appJsx.slice(appJsx.indexOf("function MarketingPlanCampaignPlannerScreen("), appJsx.indexOf("function MarketingPlanTimelineScreen("));
    expect(plannerSource).toContain("Manage Campaign");
    expect(plannerSource).toContain("archiveMarketingPlanCampaignTag");
    expect(plannerSource).toContain("restoreMarketingPlanCampaignTag");
    expect(plannerSource).toContain("Include archived");
    expect(plannerSource).toContain("Function Colour Tag");
    ...
    expect(timelineSource).not.toContain("window.addFlowMateMarketingCampaignTag");
