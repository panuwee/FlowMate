...
const WHA_HAT_SVG = '<svg viewBox="0 0 44 54" xmlns="http://www.w3.org/2000/svg">' + '<path d="M9 6 C12 3 17 3 18 7 C19 10 20 14 21 18 L33 39 C35 42 33 46 28 47 C20 49 11 48 7 44 C5 42 6 38 7 35 L12 13 C12 10 11 8 9 6 Z" fill="#f5ead0" stroke="#1a1410" stroke-width="2" stroke-linejoin="round"/>' + '<path d="M18 7 C19 10 20 14 21 18 L33 39 C35 42 33 46 28 47 C24 48 20 48 17 47 L15 16 C16 11 16 8 18 7 Z" fill="#a9b0b8" opacity="0.85"/>' + '<path d="M6 38 C16 45 28 44 34 38" fill="none" stroke="#1a1410" stroke-width="1.6" stroke-linecap="round"/>' + '<circle cx="16" cy="35" r="1.8" fill="#cf9b46"/>' + '<circle cx="10" cy="5.5" r="2.6" fill="#cf9b46" stroke="#1a1410" stroke-width="1"/>' + '</svg>';
