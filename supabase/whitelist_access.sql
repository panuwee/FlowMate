...
-- Real remains a member while retaining the narrowly scoped Marketing
-- schedule capability on canonical whitelist reruns.
update public.users
   set can_manage_marketing_schedule = true,
       updated_at = now()
