...
const FLOWMATE_SIZE_TEMPLATE_OPTIONS = [{
  ...
  width: 1200,
  height: 630,
  label: "FB 1200x630 Landscape",
  formatType: "Static"
}, {
  channel: "Facebook",
  typeSkill: "video-standard",
  placement: "Vertical",
  width: 1080,
  height: 1920,
  label: "FB 1080x1920 Vertical",
  formatType: "Video"
}, {
  channel: "Instagram",
  typeSkill: "banner",
  ...
  width: 1080,
  height: 1080,
  label: "IG 1080x1080 Feed",
  formatType: "Static"
}, {
  channel: "Instagram",
  typeSkill: "banner",
  placement: "Story/Reels",
  width: 1080,
  height: 1920,
  label: "IG 1080x1920 Story/Reels",
  formatType: "Static"
}, {
  channel: "Instagram",
  typeSkill: "video-standard",
  ...
  width: 1080,
  height: 1920,
  label: "IG 1080x1920 Vertical",
  formatType: "Video"
}, {
  channel: "TikTok",
  typeSkill: "video-under-1-min",
  placement: "Vertical",
  width: 1080,
  height: 1920,
  label: "TikTok 1080x1920 Vertical",
  formatType: "Video"
}, {
  channel: "YouTube",
  typeSkill: "video-standard",
  ...
  width: 1920,
  height: 1080,
  label: "YouTube 1920x1080 Landscape",
  formatType: "Video"
}, {
  channel: "YouTube",
  typeSkill: "banner",
  ...
  width: 1280,
  height: 720,
  label: "YouTube 1280x720 Thumbnail",
  formatType: "Thumbnail"
}, {
  channel: "In-game",
  typeSkill: "banner",
  placement: "Full Size Splash",
  width: 730,
  height: 504,
  label: "Full Size Splash",
  formatType: "Static"
}, {
  channel: "In-game",
  typeSkill: "banner",
  placement: "1/3 Splash",
  width: 730,
  height: 166,
  label: "1/3 Splash",
  formatType: "Static"
  ...
  channel: "In-game",
  typeSkill: "banner",
  placement: "PNG Free Roam + In-web",
  width: 240,
  height: 76,
  label: "PNG Free Roam + In-web",
  formatType: "Static"
}, {
  channel: "In-game",
  typeSkill: "banner",
  placement: "Scroll Banner",
  width: 240,
  height: 160,
  label: "Scroll Banner",
  formatType: "Static"
  ...
  channel: "In-game",
  typeSkill: "banner",
  placement: "Mission Hub Web Event",
  width: 668,
  height: 157,
  label: "Mission Hub Web Event",
  formatType: "Static"
}, {
  channel: "In-game",
  typeSkill: "banner",
  placement: "In-game Free Roam",
  width: 240,
  height: 93,
  label: "In-game Free Roam",
  formatType: "Static"
}, {
  channel: "In-game",
  typeSkill: "banner",
  placement: "In-game Tab Shop",
  width: 1359,
  height: 144,
  label: "In-game Tab Shop",
  formatType: "Static"
}, {
  channel: "Other",
  typeSkill: "custom",
  placement: "Custom size",
  width: 0,
  height: 0,
  label: "Custom size",
  formatType: "Other"
...
function getFlowMateSizeSuggestions(typeSkill, channels) {
  ...
  const matches = FLOWMATE_SIZE_TEMPLATE_OPTIONS.filter(option => {
    ...
    const typeMatch = optionType === type || optionType === "custom" || isVideo && option.formatType === "Video" || !isVideo && option.formatType !== "Video" && optionType === "banner";
...
function normalizeFlowMateSelectedSizes(value) {
  ...
  return sizes.filter(size => size && typeof size === "object").map(size => ({
...
function getFlowMateStructuredBriefSummary(draft) {
  ...
  return [common.objective, common.target_audience, common.key_message, staticBrief.visual_direction, videoBrief.hook].map(item => String(item || "").trim()).filter(Boolean).join(" | ");
}
...
function normalizeFlowMateCreativeDraft(draft) {
  ...
  return {
    ...
    structuredBrief: getFlowMateStructuredBriefSummary({
      ...nextDraft,
      ...normalizedBrief
    }),
...
const FLOWMATE_CREATE_DRAFT_FIELDS = {
  ...
  creative: ["title", "requesterTeam", "campaignName", "productEvent", "assetType", "assetSubtype", "assetCount", "platforms", "sizeFormat", "selectedSizes", "structuredBrief", "commonBrief", "staticBrief", "videoBrief", "briefLink", "briefNote", "referenceLink", "priority", "urgentReason", "dueDate", "launchDate", "publishTime", "marketingPlanContentItemId", "marketingPlanOriginalBriefLink", "marketingPlanProductEvent", "marketingPlanCampaignName"]
};
...
function getFlowMateCreateDraftPayload(kind, draft, fallback = {}) {
  ...
  return fields.reduce((payload, field) => {
    ...
    if (field === "selectedSizes") {
      ...
      payload[field] = value && typeof value === "object" && !Array.isArray(value) ? {
        ...value
      } : {};
    } else {
...
function CreativeRequestForm({
  ...
  function toggleSize(option) {
    const nextSizes = isFlowMateSizeSelected(selectedSizes, option) ? selectedSizes.filter(size => getFlowMateSizeLabel(size) !== getFlowMateSizeLabel(option)) : [...selectedSizes, option];
    const nextSizeFormat = nextSizes.map(getFlowMateSizeLabel).filter(Boolean).join(", ");
    updateDraft({
      selectedSizes: nextSizes,
      sizeFormat: nextSizeFormat || value.sizeFormat
    });
  }
  return React.createElement("div", null, React.createElement("div", {
    ...
    className: "field__label"
  }, "Size / format"), React.createElement("input", {
    className: "input",
    value: value.sizeFormat,
    onChange: e => update("sizeFormat", e.target.value),
    placeholder: "Custom size or selected presets, e.g. 1080x1350"
  }), React.createElement("div", {
    className: "check-row",
    style: {
      marginTop: 8
    }
  }, sizeSuggestions.map(option => React.createElement("label", {
    key: `${option.channel}-${option.label}-${option.width}x${option.height}`,
    className: "check-pill"
  }, React.createElement("input", {
    type: "checkbox",
    checked: isFlowMateSizeSelected(selectedSizes, option),
    onChange: () => toggleSize(option)
  }), React.createElement("span", null, getFlowMateSizeLabel(option))))), React.createElement("div", {
    className: "muted",
    style: {
      fontSize: 12,
      marginTop: 6
    }
  }, "Pick approved placements such as Full Size Splash or Mission Hub Web Event, or type a Custom size."), errors.sizeFormat && React.createElement("div", {
    className: "field__error"
    ...
    className: "field__label"
  }, "Structured brief"), React.createElement("div", {
    className: "form-grid",
    style: {
      marginTop: 0
    }
    ...
    className: "field__label"
  }, "Objective"), React.createElement("input", {
    className: "input",
    value: commonBrief.objective || "",
    onChange: e => updateBrief("commonBrief", "objective", e.target.value),
    placeholder: "What should this asset achieve?"
  })), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Target audience"), React.createElement("input", {
    className: "input",
    value: commonBrief.target_audience || "",
    onChange: e => updateBrief("commonBrief", "target_audience", e.target.value),
    placeholder: "Who should see this?"
  })), React.createElement("div", {
    className: "field field--full"
  }, React.createElement("label", {
    className: "field__label"
  }, "Key message"), React.createElement("input", {
    className: "input",
    value: commonBrief.key_message || "",
    onChange: e => updateBrief("commonBrief", "key_message", e.target.value),
    placeholder: "Single main message."
  })), isVideoRequest ? React.createElement(React.Fragment, null, React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Duration"), React.createElement("input", {
    className: "input",
    value: videoBrief.duration || "",
    onChange: e => updateBrief("videoBrief", "duration", e.target.value),
    placeholder: "e.g. 15 sec"
  })), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Aspect ratio"), React.createElement("input", {
    className: "input",
    value: videoBrief.aspect_ratio || "",
    onChange: e => updateBrief("videoBrief", "aspect_ratio", e.target.value),
    placeholder: "e.g. 9:16"
  })), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Hook"), React.createElement("input", {
    className: "input",
    value: videoBrief.hook || "",
    onChange: e => updateBrief("videoBrief", "hook", e.target.value),
    placeholder: "Opening idea."
  })), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Script / storyboard"), React.createElement("input", {
    className: "input",
    value: videoBrief.script_storyboard || "",
    onChange: e => updateBrief("videoBrief", "script_storyboard", e.target.value),
    placeholder: "Script, shot list, or storyboard link."
  }))) : React.createElement(React.Fragment, null, React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Visual direction"), React.createElement("input", {
    className: "input",
    value: staticBrief.visual_direction || "",
    onChange: e => updateBrief("staticBrief", "visual_direction", e.target.value),
    placeholder: "Mood, style, visual references."
  })), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
  }, "Text hierarchy"), React.createElement("input", {
    className: "input",
    value: staticBrief.text_hierarchy || "",
    onChange: e => updateBrief("staticBrief", "text_hierarchy", e.target.value),
    placeholder: "Headline, sub text, CTA order."
  }))))), React.createElement("div", {
    className: "field"
  }, React.createElement("label", {
    className: "field__label"
...
function DetailScreen({
  ...
  return React.createElement("div", {
    ...
    target: "_blank",
    rel: "noopener noreferrer"
  }, "Open reference") : "-")), w.status === "need_brief" && React.createElement("div", {
    className: "meta-row"
  }, React.createElement("div", {
    className: "meta-row__lbl"
  }, "Missing brief reason"), React.createElement("div", {
    className: "meta-row__val"
  }, w.missingBriefReason || w.queueReason || "Required brief fields are missing.")), React.createElement("div", {
    className: "meta-row"
  }, React.createElement("div", {
    className: "meta-row__lbl"
  }, "Structured brief"), React.createElement("div", {
    className: "meta-row__val"
  }, w.commonBrief?.key_message || w.staticBrief?.visual_direction || w.videoBrief?.hook || "-")), Array.isArray(w.selectedSizes) && w.selectedSizes.length > 0 && React.createElement("div", {
    className: "meta-row"
  }, React.createElement("div", {
    className: "meta-row__lbl"
  }, "Selected sizes"), React.createElement("div", {
    className: "meta-row__val"
  }, w.selectedSizes.map(size => size.label || size.value || `${size.width || ""}x${size.height || ""}`).filter(Boolean).join(", "))))), React.createElement("div", {
    className: "card"
  }, React.createElement("div", {
    className: "card__head"
  }, React.createElement("span", {
