...
4. Upload the changed tracked runtime/source, test, and handoff files through the approved manual GitHub web UI workflow. Upload non-entry files first, including `app.css`, `app.jsx`, `app.js`, `screens-ot.jsx`, and `screens-ot.js`.
